        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              children: <Widget>[
                Positioned(
                  child: Container(
                    ...
                    child: Hero(
                        ...
                        child: Stack(
                          children: <Widget>[Center(child: Image(image: AssetImage(widget.car.imageName)))],
                        )),
                  ),
                ),
                Positioned(
                ...
                Positioned(
                  ...
                  child: SafeArea(
                    child: Text(
                      widget.car.carName,
                      style: TextStyle(fontFamily: descFont, color: Colors.white, fontWeight: FontWeight.w900, fontSize: 25),
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: SafeArea(
                    child: Column(
                      children: <Widget>[
                        Text(
                          "Starting at:",
                          style: TextStyle(fontFamily: titleFont, color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),
                        ),
                        Text(
                          widget.car.carPrice,
                          style: TextStyle(color: Colors.white, fontFamily: descFont, fontWeight: FontWeight.w900, fontSize: 20),
                        )
                      ],
                    ),
                  ),
            ...
            Padding(
              ...
              child: Text(
                "Description",
                style: TextStyle(fontFamily: descFont, fontSize: 18, fontWeight: FontWeight.w900),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 15.0, top: 10),
              child: Text(
                ...
                style: TextStyle(fontFamily: titleFont, fontSize: 16),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 15.0, top: 10),
