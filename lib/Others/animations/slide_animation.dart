...
class SlideAnimationListItem extends StatefulWidget{
  final int position;
  final int itemCount;
  final Widget child;
  ...
  @override
  _SlideAnimationListItemState createState() => _SlideAnimationListItemState();
}

class _SlideAnimationListItemState extends State<SlideAnimationListItem> with TickerProviderStateMixin{
