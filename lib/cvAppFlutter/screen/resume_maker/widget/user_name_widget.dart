                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: TextStyle(color: Color(getColorHexFromStr(TEXT_COLOR_BLACK)), fontSize: MediaQuery.of(context).size.shortestSide * 0.06, letterSpacing: 0.8),
                        softWrap: true,
                        textAlign: TextAlign.left,
                      ),
                      Text(
                        _bloc.profile != null ? _bloc.profile.designation : '',
                        style: TextStyle(color: Color(getColorHexFromStr(TEXT_COLOR_BLACK)), fontSize: MediaQuery.of(context).size.shortestSide * 0.04, letterSpacing: 0.8),
                        softWrap: true,
                        textAlign: TextAlign.left,
                      ),
                    ],
