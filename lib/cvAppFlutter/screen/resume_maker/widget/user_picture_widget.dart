...
import 'package:e_commerce_app/cvAppFlutter/screen/resume_maker/bloc/resume_maker_bloc.dart';
        ...
        builder: (BuildContext buildContext, AsyncSnapshot<double> snapshot) {
          ...
          return Transform.scale(
            ...
            child: Transform.translate(
              offset: Offset(-_getXOffset(pageOffset, MediaQuery.of(context).size.width), -_getYOffset(pageOffset, MediaQuery.of(context).size.height)),
              child: Stack(
                alignment: Alignment.center,
                children: <Widget>[
