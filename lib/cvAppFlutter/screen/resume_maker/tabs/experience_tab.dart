import 'package:e_commerce_app/cvAppFlutter/model/resume_model.dart';
import 'package:e_commerce_app/cvAppFlutter/screen/add_experience/add_experience_dialog.dart';
import 'package:e_commerce_app/cvAppFlutter/screen/resume_maker/bloc/bloc_provider.dart';
import 'package:e_commerce_app/cvAppFlutter/screen/resume_maker/widget/onboarding_header_text.dart';
import 'package:e_commerce_app/cvAppFlutter/utility/color_utility.dart';
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(color: Color(getColorHexFromStr(TEXT_COLOR_BLACK)), fontSize: MediaQuery.of(context).size.shortestSide * 0.05, letterSpacing: 0.8),
                  softWrap: true,
                ...
                Text(
                  ...
                  style: TextStyle(color: Color(getColorHexFromStr(TEXT_COLOR_BLACK)), fontSize: MediaQuery.of(context).size.shortestSide * 0.04, fontWeight: FontWeight.w500, letterSpacing: 0.8),
                  softWrap: true,
                  textAlign: TextAlign.left,
                ),
                SizedBox(
                ...
                Row(
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(color: Color(getColorHexFromStr(TEXT_COLOR_BLACK)), fontSize: MediaQuery.of(context).size.shortestSide * 0.03, letterSpacing: 0.8),
                      softWrap: true,
                      textAlign: TextAlign.left,
                    ),
                    Text(
