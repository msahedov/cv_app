...
import 'package:e_commerce_app/cvAppFlutter/widget/country_code_picker.dart';
import 'package:e_commerce_app/cvAppFlutter/widget/custom_text_feild_form.dart';
import 'package:e_commerce_app/cvAppFlutter/widget/rounded_button.dart';
...
class _ContactTabState extends State<ContactTab> {
  ...
  void _onAddContact() {
    ...
    if (_formKey.currentState.validate()) {
      ...
      _bloc.contact = Contact(email: _emailController.text, phone: _phoneController.text, linkedin: _linkedController.text, countryCode: _codeController.text);
