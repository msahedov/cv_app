...
import 'package:e_commerce_app/cvAppFlutter/utility/constants.dart';
import 'package:e_commerce_app/cvAppFlutter/utility/create_pdf.dart';
...
class ResumeMakerBloc {
  ...
  Stream<Experience> get experienceListModifiedStream => _experienceListModifiedBehaviorSubject.stream.asBroadcastStream();
  ...
  Stream<bool> get saveProfileSummaryButtonEnableStream => _saveProfileSummaryButtonEnableBehaviorSubject.stream.asBroadcastStream();
